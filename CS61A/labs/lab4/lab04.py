...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    # Make point of interest as a city construct
    point_of_interest = make_city("", lat, lon)

    dist_to_1, dist_to_2 = distance(point_of_interest, city1), distance(point_of_interest, city2)
